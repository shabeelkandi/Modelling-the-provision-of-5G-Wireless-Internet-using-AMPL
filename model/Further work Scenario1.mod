#Minimise the total amount of data lost per second 
...
#objective : to minimise total transmission loss
minimize total_transmission_loss : sum{a in ANTENNAS,z in ZONES} zone_dist[a,z]*(theta1[a,z]*0 + theta2[a,z]*0.05 + theta3[a,z]*0.075);
