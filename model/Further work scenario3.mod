#Minimise maximum Antenna utilization with data loss constraint
...
max_data_loss :sum{a in ANTENNAS,z in ZONES} zone_dist[a,z]*(theta1[a,z]*0 + theta2[a,z]*0.05 + theta3[a,z]*0.075)<=data_loss;
